    ...
    <>
      <button type="button" className="flex bg-grey relative mb-3 md:mb-0 h-10 items-center ">
        <a href="/" className="flex px-1 items-center" download>
          <img src={leftSide} alt="lef-side" className="absolute -left-[13px] bottom-0 " />
          <img src={download} alt="download" className="flex " />
          <p className=" flex text-base font-medium text-light uppercase ml-2.5 font-oswald">
            download
          </p>
          <img src={rightSide} alt="right-side" className="absolute left-[112px] bottom-0 " />
        </a>
      </button>
    </>
  );
