...
const ButtonPreorder = () => {
    return (
    <button className='hidden xl:flex xl:relative xl:items-center xl:bg-light xl:h-[39.5px]' type='button'>
        ...
        <p className='hidden xl:flex xl:pl-2.5 xl:text-base xl:uppercase xl:font-medium xl:text-blackText font-oswald'>preorder now</p>
        <img className='hidden xl:flex xl:absolute xl:left-[109px]' src={rightSide} alt='right-side-btn' />
    </button>    
  )
}
